          ...
          <div class="col-lg-12">
            <div class="ibox float-e-margins">
              <div class="ibox-title">
                <h5>All Setting For This Websites</h5>
                <div class="ibox-tools"> <a class="btn aqua btn-xs" href="{{ route('setting.create')}}">Create new setting</a> </div>
              </div>
                    ...
                    <table id="proList" class="table table-hover  responsive nowrap table-bordered" cellspacing="0" width="100%">
                      ...
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td class="project-title"><a>{{ $setting->email }}</a> <br>
                          </td>
                          ...
                          <td class="project-actions"><a class="aqua btn btn-outline btn-sm" href="{{ route('setting.show', $setting->id) }}"><i class="fa fa-folder"></i> View </a> <a class="red btn btn-outline btn-sm" href="{{ route('setting.edit', $setting->id) }}"><i class="fa fa-pencil"></i> Edit </a> </td>
                          <td>
