          ...
          <div class="col-lg-12">
            <div class="ibox float-e-margins">
              <div class="ibox-title">
                <h5>All Client For This Websites</h5>
                <div class="ibox-tools"> <a class="btn aqua btn-xs" href="{{ route('client.create')}}">Create new client</a> </div>
              </div>
                    ...
                    <table id="proList" class="table table-hover  responsive nowrap table-bordered" cellspacing="0" width="100%">
                      ...
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td class="project-title"><a>{!! substr(strip_tags($client->name), 0, 20) !!} {!! strlen(strip_tags($client->name)) > 20 ? "...." : "" !!}</a> <br>
                          </td>
                          <td>{!! substr(strip_tags($client->content), 0, 100) !!} {!! strlen(strip_tags($client->content)) > 100 ? "...." : "" !!}</td>
                          <td>{{ $client->position }}</td>
                          <td class="project-actions"><a class="aqua btn btn-outline btn-sm" href="{{ route('client.show', $client->id) }}"><i class="fa fa-folder"></i> View </a> <a class="red btn btn-outline btn-sm" href="{{ route('client.edit', $client->id) }}"><i class="fa fa-pencil"></i> Edit </a> </td>
                          <td>
