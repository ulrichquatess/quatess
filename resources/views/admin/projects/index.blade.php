          ...
          <div class="col-lg-12">
            <div class="ibox float-e-margins">
              <div class="ibox-title">
                <h5>All Project For This Websites</h5>
                <div class="ibox-tools"> <a class="btn aqua btn-xs" href="{{ route('project.create')}}">Create new project</a> </div>
              </div>
                    ...
                    <table id="proList" class="table table-hover  responsive nowrap table-bordered" cellspacing="0" width="100%">
                      ...
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td class="project-title"><a>{!! substr(strip_tags($project->title), 0, 20) !!} {!! strlen(strip_tags($project->title)) > 20 ? "...." : "" !!}</a> <br>
              </td>
                          <td>{!! substr(strip_tags($project->content), 0, 50) !!} {!! strlen(strip_tags($project->content)) > 50 ? "...." : "" !!}</td>
                          <td>{{ $project->slug }}</td>
                          <td class="project-actions"><a class="aqua btn btn-outline btn-sm" href="{{ route('project.show', $project->id) }}"><i class="fa fa-folder"></i> View </a> <a class="red btn btn-outline btn-sm" href="{{ route('project.edit', $project->id) }}"><i class="fa fa-pencil"></i> Edit </a> </td>
                          <td>
