      ...
      <div class="row wrapper border-bottom page-heading">
        <div class="col-lg-12">
          ...
          <ol class="breadcrumb">
            ...
            <li> <a> Apps </a> </li>
            <li class="active"> <strong>Team </strong> </li>
          </ol>
        </div>
      </div>
          ...
          <div class="col-lg-12">
            <div class="ibox float-e-margins">
              <div class="ibox-title">
                <h5>All Team For This Websites</h5>
                <div class="ibox-tools"> <a class="btn aqua btn-xs" href="{{ route('team.create')}}">Create new team</a> </div>
              </div>
                    ...
                    <table id="proList" class="table table-hover  responsive nowrap table-bordered" cellspacing="0" width="100%">
                      ...
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td class="project-title"><a>{!! substr(strip_tags($team->name), 0, 20) !!} {!! strlen(strip_tags($team->name)) > 20 ? "...." : "" !!}</a> <br>
                           </td>
                          <td>{!! substr(strip_tags($team->content), 0, 50) !!} {!! strlen(strip_tags($team->content)) > 50 ? "...." : "" !!}</td>
                          <td>{{ $team->position }}</td>
                          <td class="project-actions"><a class="aqua btn btn-outline btn-sm" href="{{ route('team.show', $team->id) }}"><i class="fa fa-folder"></i> View </a> <a class="red btn btn-outline btn-sm" href="{{ route('team.edit', $team->id) }}"><i class="fa fa-pencil"></i> Edit </a> </td>
                          <td>
