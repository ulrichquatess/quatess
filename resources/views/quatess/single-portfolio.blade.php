...
<a class="modal" rel="{handler: 'image'}" href="{{asset('images/portfolios/'.$portfolio->image)}}" title="Click to preview image">
<span class="itemImageZoom"></span>
<span class="itemImageFrame"></span>
<img src="{{asset('images/portfolios/'.$portfolio->image)}}" alt="How To Be An Effective In-house SEO" style="width:1130px; height:auto;" />
<!-- Featured flag -->
...
<span class="itemDateModified">
					Last modified on {{ date( 'M j Y h:ia ', strtotime( $portfolio->updated_at ))}}				</span>
<div class="clr"></div>
</div>
