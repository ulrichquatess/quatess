...
<div class="cbp-item Branding"><a data-id="51" href="{{ url('projects/'.$project->slug)}}" class="cbp-caption su-blog-img">
<div class="cbp-caption-defaultWrap"><img src="{{asset('images/projects/'.$project->image)}}" alt="Digital Business Cards"></div><div class="cbp-caption-activeWrap">
...
</div></a><a href="{{ url('projects/'.$project->slug)}}" class="cbp-l-grid-blog-title">{!! substr(strip_tags($project->title), 0, 90) !!} {!! strlen(strip_tags($project->title)) > 90 ? "...." : "" !!}</a>
<div class="su-pgrid-meta">
<span class="cbp-l-grid-blog-date">20 September 2015</span>
<span class="cpb-category">Branding</span>
</div>
<div class="cbp-l-grid-blog-desc">{!! substr(strip_tags($project->content), 0, 90) !!} {!! strlen(strip_tags($project->content)) > 90 ? "...." : "" !!}</div>
</div>
@endforeach
